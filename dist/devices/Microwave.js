...
import { cookingAlarmServiceUpdate, cookingStopCommand, cookingTimerServiceUpdate, durationFromSnapshot, hasActiveCookingState, hasCookingModeActive, hasNonZeroSnapshotNumber, homeKitTemperatureFromSnapshot, isFahrenheitUnit, isInitialCookingState, microwaveRemoteStartCommand, microwaveTimerCommand, microwaveVentLampCommand, microwavePowerPercent, prepareMicrowaveCookCommand, temperatureDisplayUnitsValue, } from './cooking.js';
...
export default class Microwave extends BaseDevice {
    ...
    remainTime() {
        return durationFromSnapshot(this.Status.data, 'LWORemainTimeHour', 'LWORemainTimeMinute', 'LWORemainTimeSecond');
    }
    ovenModeName() {
    ...
    oventTargetTime() {
        return durationFromSnapshot(this.Status.data, 'LWOTargetTimeHour', 'LWOTargetTimeMinute', 'LWOTargetTimeSecond');
    }
    ovenTimerTime() {
        return durationFromSnapshot(this.Status.data, 'LWOTimerHour', 'LWOTimerMinute', 'LWOTimerSecond');
    }
    tempCtoF(temp) {
    ...
    updateAccessoryCharacteristic(device) {
        ...
        if (!this.pauseUpdate) {
            ...
            ///////Timer Monitor
            const timerServiceUpdate = cookingTimerServiceUpdate(this.remainTime(), this.oventTargetTime(), this.onStatus(), Characteristic.InUse);
