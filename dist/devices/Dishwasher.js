...
import { contactSensorStateValue, snapshotNumber, snapshotString, updateCharacteristicIfChanged, } from './helpers.js';
const DEFAULT_DISHWASHER_STATUS_DATA = {
    state: 'OFF',
    process: 'NONE',
    door: 'CLOSE',
    course: '',
...
const withDishwasherDefaults = (data) => {
    const normalized = {
...
function dishwasherDuration(data, hourKey, minuteKey) {
    return snapshotNumber(data, hourKey) * 3600 + snapshotNumber(data, minuteKey) * 60;
}
function legacyWasherDryerRemainDuration(data) {
...
export function readDishwasherState(data, deviceModel) {
...
export default class Dishwasher extends BaseDevice {
    ...
    currentInputName() {
        ...
        updateCharacteristicIfChanged(this.dishwasherOptions, this.platform.Characteristic.TargetVisibilityState, this.onStatus() ? this.platform.Characteristic.TargetVisibilityState.SHOWN : this.platform.Characteristic.TargetVisibilityState.HIDDEN);
        updateCharacteristicIfChanged(this.dishwasherOptions, this.platform.Characteristic.CurrentVisibilityState, this.onStatus() ? this.platform.Characteristic.CurrentVisibilityState.SHOWN : this.platform.Characteristic.CurrentVisibilityState.HIDDEN);
    }
    timeDurationEnd() {
        /////Cycle duration
        this.showTime = true;
        ...
        updateCharacteristicIfChanged(this.startTime, this.platform.Characteristic.TargetVisibilityState, this.showTime ? this.platform.Characteristic.TargetVisibilityState.SHOWN : this.platform.Characteristic.TargetVisibilityState.HIDDEN);
        updateCharacteristicIfChanged(this.startTime, this.platform.Characteristic.CurrentVisibilityState, this.showTime ? this.platform.Characteristic.CurrentVisibilityState.SHOWN : this.platform.Characteristic.CurrentVisibilityState.HIDDEN);
        updateCharacteristicIfChanged(this.courseDuration, this.platform.Characteristic.TargetVisibilityState, this.showTime ? this.platform.Characteristic.TargetVisibilityState.SHOWN : this.platform.Characteristic.TargetVisibilityState.HIDDEN);
        updateCharacteristicIfChanged(this.courseDuration, this.platform.Characteristic.CurrentVisibilityState, this.showTime ? this.platform.Characteristic.CurrentVisibilityState.SHOWN : this.platform.Characteristic.CurrentVisibilityState.HIDDEN);
        updateCharacteristicIfChanged(this.endTime, this.platform.Characteristic.TargetVisibilityState, this.showTime ? this.platform.Characteristic.TargetVisibilityState.SHOWN : this.platform.Characteristic.TargetVisibilityState.HIDDEN);
        updateCharacteristicIfChanged(this.endTime, this.platform.Characteristic.CurrentVisibilityState, this.showTime ? this.platform.Characteristic.CurrentVisibilityState.SHOWN : this.platform.Characteristic.CurrentVisibilityState.HIDDEN);
    }
    setActive() {
    ...
    updateRinseLevel() {
        ...
        if (this.Status.data.tclCount > 30) {
            ...
            updateCharacteristicIfChanged(this.dishwasherClaenness, this.platform.Characteristic.TargetVisibilityState, this.onStatus() ? this.platform.Characteristic.TargetVisibilityState.SHOWN : this.platform.Characteristic.TargetVisibilityState.HIDDEN);
            updateCharacteristicIfChanged(this.dishwasherClaenness, this.platform.Characteristic.CurrentVisibilityState, this.onStatus() ? this.platform.Characteristic.CurrentVisibilityState.SHOWN : this.platform.Characteristic.CurrentVisibilityState.HIDDEN);
        }
        else {
            this.inputNameMachine = 'Dishwasher is Clean';
            updateCharacteristicIfChanged(this.dishwasherClaenness, this.platform.Characteristic.ConfiguredName, this.inputNameMachine);
            updateCharacteristicIfChanged(this.dishwasherClaenness, this.platform.Characteristic.TargetVisibilityState, this.platform.Characteristic.TargetVisibilityState.HIDDEN);
            updateCharacteristicIfChanged(this.dishwasherClaenness, this.platform.Characteristic.CurrentVisibilityState, this.platform.Characteristic.CurrentVisibilityState.HIDDEN);
        }
        updateCharacteristicIfChanged(this.dishwasherRinseLevel, this.platform.Characteristic.ConfiguredName, this.inputNameRinse);
        updateCharacteristicIfChanged(this.dishwasherRinseLevel, this.platform.Characteristic.TargetVisibilityState, this.onStatus() ? this.platform.Characteristic.TargetVisibilityState.SHOWN : this.platform.Characteristic.TargetVisibilityState.HIDDEN);
        updateCharacteristicIfChanged(this.dishwasherRinseLevel, this.platform.Characteristic.CurrentVisibilityState, this.onStatus() ? this.platform.Characteristic.CurrentVisibilityState.SHOWN : this.platform.Characteristic.CurrentVisibilityState.HIDDEN);
    }
    onStatus() {
