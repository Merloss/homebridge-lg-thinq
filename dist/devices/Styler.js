...
export const NOT_RUNNING_STATUS = ['POWEROFF', 'INITIAL', 'PAUSE', 'COMPLETE', 'ERROR', 'DIAGNOSIS', 'RESERVED',
    'SLEEP', 'FOTA'];
export function readStylerState(data, deviceModel) {
...
export default class Styler extends BaseDevice {
    ...
    updateAccessoryCharacteristic(device) {
        ...
        updateCharacteristicIfChanged(this.serviceStyter, Characteristic.StatusFault, this.Status.isError ? Characteristic.StatusFault.GENERAL_FAULT : Characteristic.StatusFault.NO_FAULT);
    }
