...
export class Auth {
     ...
     */
    constructor(gateway, logger = createNoopLogger()) {
    ...
    async loginStep2(username, encrypted_password, extra_headers) {
        ...
        return new Session(token.access_token, token.refresh_token, Session.expiryTimestampFromExpiresIn(parseInt(token.expires_in, 10)));
    }
    /**
